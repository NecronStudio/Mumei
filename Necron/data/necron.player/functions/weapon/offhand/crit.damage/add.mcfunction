#> necron.player:weapon/offhand/crit.damage/add
#
# クリティカルダメージを追加
#
...
# 追加クリティカルダメージを保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Weapon.Offhand.CritDamage int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
