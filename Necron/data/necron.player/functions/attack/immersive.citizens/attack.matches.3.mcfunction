...
execute as @a[tag=NSD.ShowDealt] at @s if score @s NSD.Dealt.0 matches 1.. run tellraw @s [{"text":">>> ","color":"white"},{"score":{"name":"$NSD.Enemy.Left.HP.0","objective":"NSD.HP"},"color":"red"},{"text":"ダメージ","color":"white"}]
