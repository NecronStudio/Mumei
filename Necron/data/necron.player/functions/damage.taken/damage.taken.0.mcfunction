...
# ftfrsgtdeddz
scoreboard players operation $S2000000000 NSD.S = $NSD.2000000000 NSD.Const
scoreboard players operation $S1000000000 NSD.S = $NSD.1000000000 NSD.Const
scoreboard players operation $S100000000 NSD.S = $NSD.100000000 NSD.Const
