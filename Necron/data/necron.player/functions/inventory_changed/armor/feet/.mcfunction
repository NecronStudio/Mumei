...
# 最大体力
	...
	# 増加が無かったら
	execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Armor.Feet.HPMax unless data storage necron: Items[{Slot:100b}].tag.NSD.Status.HPMax run function necron.player:inventory_changed/armor/feet/hp.max/remove
	# 値を取得
	...
	# 前に持っていた値より大きかったら
	execute if data storage necron: Items[{Slot:100b}].tag.NSD.Status.HPMax unless score $NSD.Value NSD.Temp = $NSD.Amount NSD.Temp run function necron.player:inventory_changed/armor/feet/hp.max/add
# 最大魔力
	# 追加値を取得
	...
	# 増加が無かったら
	execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Armor.Feet.MPMax unless data storage necron: Items[{Slot:100b}].tag.NSD.Status.MPMax run function necron.player:inventory_changed/armor/feet/mp.max/remove
	# 値を取得
	...
	# 前に持っていた値より大きかったら
	execute if data storage necron: Items[{Slot:100b}].tag.NSD.Status.MPMax unless score $NSD.Value NSD.Temp = $NSD.Amount NSD.Temp run function necron.player:inventory_changed/armor/feet/mp.max/add
# 防御力
	# 追加値を取得
