#> necron.player:inventory_changed/armor/chest/mp.max/add
#
# 最大魔力を追加
#
...
# 追加最大魔力を保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Armor.Chest.MPMax int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
