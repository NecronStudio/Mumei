#> necron.player:inventory_changed/return.item
#
# アイテムを返す
#
# @within function necron.player:inventory_changed/default.items/exchange/return.item
# @within function necron.player:inventory_changed/accessory/give/exchange/loop

# 
#> Scoreholder
#@within necron.player:inventory_changed/**
...
# アイテムをチェスト付きトロッコに入れる
	...
	data modify entity @e[type=minecraft:chest_minecart,tag=NSD.ChestMinecart,distance=..0.001,limit=1] Items append from storage necron: ReturnItem
# アイテムを返す
