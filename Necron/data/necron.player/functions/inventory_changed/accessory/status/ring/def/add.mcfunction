#> necron.player:inventory_changed/accessory/status/ring/def/add
#
# 防御力を追加
#
...
# 追加防御力を保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Ring.DEF int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
