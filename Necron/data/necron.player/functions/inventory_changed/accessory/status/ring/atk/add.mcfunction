#> necron.player:inventory_changed/accessory/status/ring/atk/add
#
# 攻撃力を追加
#
...
# 追加攻撃力を保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Ring.ATK int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
