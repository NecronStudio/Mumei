#> necron.player:inventory_changed/accessory/status/wrist/hp.rcvr.per/remove
#
# 体力回復割合を減少
#
...
# 追加体力回復割合をリセット
	data remove storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Wrist.HPRcvrPer
# 変えたことを記録
