#> necron.player:inventory_changed/accessory/status/wrist/crit.damage/add
#
# クリティカルダメージを追加
#
...
# 追加クリティカルダメージを保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Bracelet.CritDamage int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
