#> necron.player:inventory_changed/accessory/status/wrist/hp.max/add
#
# 最大体力を追加
#
...
# 追加最大体力を保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Bracelet.HPMax int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
