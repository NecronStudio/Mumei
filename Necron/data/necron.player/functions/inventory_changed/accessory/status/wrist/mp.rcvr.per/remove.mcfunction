#> necron.player:inventory_changed/accessory/status/wrist/mp.rcvr.per/remove
#
# 魔力回復割合を減少
#
...
# 追加魔力回復割合をリセット
	data remove storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Wrist.MPRcvrPer
# 変えたことを記録
