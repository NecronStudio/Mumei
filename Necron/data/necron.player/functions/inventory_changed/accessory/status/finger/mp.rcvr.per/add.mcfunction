#> necron.player:inventory_changed/accessory/status/finger/mp.rcvr.per/add
#
# 魔力回復割合を追加
#
...
# 追加魔力回復割合を保存
	execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].NSD.Accessory.Finger.MPRcvrPer int 1 run scoreboard players get $NSD.Amount NSD.Temp
# 変えたことを記録
